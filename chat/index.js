...
chatboxForm.addEventListener('submit', function (e) {
	...
	if(isValid(textarea.value)) {
		writeMessage(); // pise poruku od user1
        setTimeout(sendMessage(), 1000); // salje poruku
	}
})

function sendMessage() {
    // on message recieve( na odgovor)
    let msg = "testna poruka"; // poruka koju bi posla

    writeMessageOfOU(msg);
}
